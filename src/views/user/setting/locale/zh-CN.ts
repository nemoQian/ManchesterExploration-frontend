export default {
  ...
  'userSetting.basicInfo.form.label.userGender': '性别',
  'userSetting.basicInfo.form.label.male': '男',
  'userSetting.basicInfo.form.label.female': '女',
  'userSetting.basicInfo.form.label.phone': '电话号码',
  'userSetting.basicInfo.form.label.updateTime': '最后更新时间',
  'userSetting.basicInfo.placeholder.phone': '请输入电话号码',
