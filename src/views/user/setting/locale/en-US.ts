export default {
  ...
  'userSetting.label.name': 'User Nickname',
  ...
  // new
  'userSetting.label.unknown': 'Unknown',
  ...
  'userSetting.label.tags': 'Tags',
  'userSetting.tab.basicInformation': 'Basic Information',
  'userSetting.tab.securitySettings': 'Security Settings',
  'userSetting.tab.tagsSettings': 'Tags',
  'userSetting.basicInfo.form.label.email': 'Email',
  'userSetting.basicInfo.placeholder.email': `Please enter your email address`,
  'userSetting.form.error.email.valid': 'Please enter valid email address',
  ...
  'userSetting.basicInfo.form.label.userGender': 'Gender',
  ...
  'userSetting.basicInfo.form.label.updateTime': 'Last Update Date',
  'userSetting.basicInfo.placeholder.phone': 'Please enter your phone number',
  'userSetting.form.error.phone.required': 'Please enter your phone number',
  'userSetting.basicInfo.form.label.area': 'Area',
  'userSetting.basicInfo.placeholder.gender': 'Please select gender',
  'userSetting.form.error.gender.required': 'Please Select a gender',
